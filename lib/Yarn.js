...
return (function(){ var yarn;
  ...
  yarn.constructor = function (blueprint) {
    blueprint = blueprint || new(Object);
    this.strip(); this.style(blueprint.styles);
  ...
  //       info.
  yarn.toString = function (quilt, containers) { var out, styles, codes;
           out = new(Array),
    ...
    if ((codes = applyCodes(styles)).length > 0) {
    ...
    if ((codes = unapplyCodes(containers, styles)).length > 0) {
      out.push(yarn.codes['csi'], codes.join(';'), yarn.codes['sgr']) };
  ...
  var fullReset = function (containers) { var styles;
    ...
    containers.forEach(function (container) {
      styles = process.mixin(null, styles, container.styles)});
